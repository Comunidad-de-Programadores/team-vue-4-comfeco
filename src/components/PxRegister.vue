  ...
  <div class="register">
    <form action method="post" autocomplete="on" @submit.prevent="registrar">
        <div class="input-group">
            <label id="nick-lbl" for="nick" class="input-group__label" >
                Nick</label>
            <input type="text" name="nick" id="nick" v-model="form.nick" :aria-label="nickLabel" class="input-group__input" placeholder="Nick" />
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
            <label id="confirm_password-lbl" for="confirm_password" class="input-group__label">
                Confirmar Contraseña</label>
            <input type="password" name="confirm_password" id="form.confirm_password" 
                v-model="form.confirm_password" class="input-group__input" 
    ...
    <p>Al resgistrate, estas aceptando los <a href="#" class="link">T&eacute;rminos y condiciones</a>, y la <a href="#" class="link">Pol&iacute;tica de privacidad y protecci&oacute;n de datos</a> de COMFECO</p>
  </div>
</template>
